...
#eca.define_evolution_config(size=1024, evolutions=2048, print_method="png_file", init_method="single_cell", )

eca.define_evolution_config(size=1000, evolutions=1000, print_method="png_file", init_method="random", )
