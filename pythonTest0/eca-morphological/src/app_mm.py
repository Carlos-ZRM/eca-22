...
eca.define_evolution_config(size=10, evolutions=10, print_method="png_file", init_method="single_cell", )

#eca.define_evolution_config(size=10, evolutions=10, print_method="png_file", init_method="random", )
